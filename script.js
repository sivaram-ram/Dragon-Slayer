...
function buyHealth() {
  if (gold >= 10) {
    ...
    text.innerText="not enough coins :( "
  }
}
...
function buyWeapon() {
  if (currentWeapon < weapons.length - 1) {
    ...
    text.innerText = "you have the ultimate weapon already";
    button2.innerText = "sell weapon and get 15 gold"
...
function goFight() {
  ...
  /*display mnstr stats div in html hidden using css*/
...
function getMonsterDamage(level) {
  let hit = (level * 5) - (Math.floor(Math.random() * 20));
  console.log(hit);
  return hit;
}
function getHit() {
